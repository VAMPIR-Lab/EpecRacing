...
annotate!([(2, 1.2, Plots.text(L"\times10^{-2}", 12, :black, :center))])
Plots.plot!(p, size=(500,400), xlabel="Simulation step", ylabel="Mean total running cost at every step", yaxis=(formatter=y->round(y*100.0; sigdigits=4)))
